...
document.addEventListener('DOMContentLoaded', () =>{
    fetch('./data.json')
        ...
        .then(data => {
            data.forEach(item =>{
                const namekey = item.name.replace(/ /g, "_");
                ordernumbers[namekey] = 0; 
                ...
                img1.setAttribute("alt", `${item.category} picture`);
                ...
                div31.classList.add("incdec", name1+"id");
                ...
                div33.classList.add("minusd");
                img21.setAttribute("src", "./assets/images/icon-decrement-quantity.svg");
                img21.classList.add("minus", name1+"minus");
                const div34 = document.createElement("div");
                div34.classList.add("plusd");
                img22.setAttribute("src", "./assets/images/icon-increment-quantity.svg");
                img22.classList.add("plus", name1+"plus");
                ...
                div4.classList.add("carttab",name1 +"cart");
                ...
                div34.addEventListener('click', () => {
                    ...
                    const arr = div34.classList[1];
                    ordernumbers[arr] = value;
                    console.log(`Incremented value: ${ordernumbers[arr]}`);
                });
        ...
        but.classList.add("confirmorder");
...
function myfunction(idbut){
    idbut.style.display = "flex";
}
function increm(val){
    var value = parseInt(val.textContent) + 1;
    return value;
}
function decrem(val){
